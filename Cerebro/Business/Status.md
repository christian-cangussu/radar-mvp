...
## 2026-09-24 06:25 — ISO 14001 Connectis/Getronics + integridade do Cérebro

🔎 Nova evidência oficial: a página de certificações da Getronics declara ISO 14001:2015 ativa em Espanha, certificado URS `EMS 133414/A/0001/UK/En`; também declara ISO 9001 e ISO 20000. Isto reduz um bloqueador do match ENAIRE, mas ainda não prova que o certificado satisfaça juridicamente o requisito para a entidade licitante Connectis ICT Services S.A.U.

⚠️ Continuam sem confirmação pública suficiente os níveis exigidos de partner Diamond UiPath / Premier Appian. Portanto Connectis permanece **Qualified Prospect**, não Preview Ready; elegibilidade não confirmada e nenhum outreach enviado.
